...
![脚本+分镜一体视图](./assets/sidebar-v6-script-storyboard.png)
...
![分镜网格视图](./assets/sidebar-v6-storyboard-grid.png)
...
![输出与交付](./assets/sidebar-v6-output-video.png)
...
![V4 主布局](./assets/sidebar-v4-main-layout.png)

![文件 Tab](./assets/sidebar-tab-file-browser.png)

![工作区 Tab](./assets/sidebar-tab-workspace.png)

![文件树增强对比](./assets/sidebar-filetree-before-after.png)

![增强型文件树](./assets/sidebar-enhanced-filetree.png)

V4 用户故事：

| 阶段 | 截图 |
|------|------|
| S1 分析 Brief | ![S1](./assets/sidebar-s1-brief-analysis.png) |
| S2 脚本创作 | ![S2](./assets/sidebar-s2-script-creation.png) |
| S3 分镜设计 | ![S3](./assets/sidebar-s3-storyboard-design.png) |
| S4 视觉生成 | ![S4](./assets/sidebar-s4-visual-generation.png) |
| S5 音频制作 | ![S5](./assets/sidebar-s5-audio-production.png) |
| S6 合成交付 | ![S6](./assets/sidebar-s6-composition-delivery.png) |
...
![V5 项目初始化](./assets/sidebar-v5-project-setup.png)

![V5 脚本与分镜](./assets/sidebar-v5-script-storyboard.png)

![V5 视觉生成高亮](./assets/sidebar-v5-visual-gen-highlight.png)

![V5 蓝白分镜布局](./assets/sidebar-v5-blue-storyboard.png)
