...
| [[raw/articles/harness-engineering/harness-engineering-deep-research]] | Filesystem memory 作为跨 session 核心记忆层、JSON > Markdown、progress files |

## 关联概念

- [[concepts/context-engineering]] — 记忆系统是上下文工程在时间维度上的延伸
- [[concepts/progressive-disclosure]] — 记忆的检索和加载遵循渐进式披露原则
- [[concepts/harness-engineering]] — Filesystem memory 是 harness 的记忆支柱
- [[concepts/agent-runtime]] — Runtime 决定记忆如何持久化和恢复
