...
| 来源 | 上下文 |
|------|------|
| `raw/articles/richard-chien/slock-ai-research.md` | slock.ai 完整研究：定位、daemon 模式、URL namespace、三种 named agents、与 HiClaw/RockClaw 对照 |
| `raw/articles/richard-chien/deep-profile.md` | slock.ai 是 RC 双线工程（Moonshot in-house + botiverse solo）的 botiverse 侧旗舰 |
| `raw/articles/richard-chien/code-review.md` | RC "co-designed and evolved" 哲学：slock 与 Wire 协议 / agent-vault 是同一套 trust boundary 的不同切面 |
